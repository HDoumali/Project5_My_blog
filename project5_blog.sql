...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 23 avr. 2018 à 12:43
...
(3, 'Comment générer des fichiers Excel (XLSX, XLS) en PHP ?', 'Cet article liste les principales solutions pour écrire des fichiers Excel aux formats XLS et XLSX à partir d\'une application PHP.', 'Commençons par mettre les choses au clair sur ce qui fut la librairie référence il y a quelques années : il ne faut plus utiliser PHPExcel pour écrire des fichiers Excel en PHP.En effet, celle librairie est abandonnée. La dernière version date du 1er mai 2015… Mais pas de panique, l’abandon de cette version s’accompagne également de la sortie de la librairie PhpSpreadsheet qui n’est autre qu’une réécriture de PHPExcel.', 'Angélique', '2018-04-11 08:11:59'),
...
INSERT INTO `comment` (`id`, `id_article`, `author`, `comment`, `comment_date`) VALUES
(1, 2, 'Paul', 'Il s\'agit en effet d\'un projet important et complet', '2018-04-10 17:29:53'),
(2, 3, 'Jean', 'Très bon article, merci pour les conseils.', '2018-04-11 08:21:41'),
(3, 4, 'Rachid', 'La sécurité est un point très important de nos jours.', '2018-04-11 08:21:41'),
(4, 5, 'Nicolas', 'Tous les langages ont leurs importances, il faut choisir celui avec lequel nous avons le plus d\'affinités', '2018-04-11 08:21:41'),
(9, 3, 'Thomas', 'Merci pour l\'article !', '2018-04-13 11:40:28'),
(34, 7, 'Céline', 'Bravo pour le test de réussite.', '2018-04-16 09:39:43'),
(28, 2, 'Nicole', 'Projet très enrichissant ! ', '2018-04-13 12:22:37');
...
(1, 'projet', '169254c45fa4ed7ea11c00541ffb17b0cde39625'),
(6, 'Hassan', '375bb4d463383a11f9a6d493ca467c88c4c4ae4a');
COMMIT;
