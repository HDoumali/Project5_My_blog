...
<head>
    ...
    <meta name="description" content="Projet 5 - Blog - Développeur d'application PHP Symfony">
    <meta name="author" content="Hassan DOUMALI">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top"><span class="glyphicon glyphicon-star" aria-hidden="true"></span>HASSAN DOUMALI</a>
            </div>
    ...
    <footer class="text-center">
                ...
                <div class="row">
                    <div class="footer-col col-md-12">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="https://twitter.com/?lang=fr" target="blank" class="btn-social btn-outline"><i class="fa fa-fw fa-twitter"></i></a>
                            </li>
                            <li>
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Hassan DOUMALI 2018
                    </div>
                </div>
            </div>
        </div>
